    ...
    <div class="card-body p-lg-17">
        ...
        <div class="mb-18">
            ...
            <div class="mb-10">
                ...
                <div class="overlay">
                    <!--begin::Image-->
                    <img class="w-100 card-rounded" src="<?= PUBLIC_URL ?>media/stock/1600x800/img-1.jpg" alt="" />
                    <!--end::Image-->

                    <!--begin::Links-->
                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                        <a href="/axel-html-pro/pages/pricing.html" class="btn btn-primary">Pricing</a>

                        <a href="/axel-html-pro/pages/careers/apply.html" class="btn btn-light-primary ms-3">Join Us</a>
                    </div>
                    <!--end::Links-->
                </div>
                <!--end::Container-->
            ...
            <div class="fs-5 fw-semibold text-gray-600">
                ...
                <p class="mb-8">
                    ...
                    <a href="/axel-html-pro/pages/blog/post.html" class="link-primary pe-1">Your Post</a>
                ...
                <p class="mb-8">
                    ...
                    <a href="/axel-html-pro/pages/blog/home.html" class="link-primary pe-1">I mean NOTHING</a>
                ...
                <p class="mb-17">
                    ...
                    company.” I feel your pain, I really do.
                    During the course of my career, I’ve written content for dozens of clients in some
                    less-than-thrilling industries (such as financial regulatory
                    compliance and corporate housing), but the hallmark of a professional blogger is the ability to
                    write well about any topic, no matter how dry it may be.
                    Blogging is a lot easier, however, if you can muster at least a little enthusiasm for the topic at
                    hand.
                </p>
                <!--end::Text-->
            </div>
        ...
        <div class="card bg-light mb-18">
            ...
            <div class="card-body py-15">
                    ...
                    <div class="d-flex flex-center flex-wrap mb-10 mx-auto gap-5 w-xl-900px">
                        ...
                        <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                            ...
                            <div class="text-center">
                                <!--begin::Symbol-->
                                <i class="ki-duotone ki-element-11 fs-2tx text-primary"><span class="path1"></span><span
                        ...
                        <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                            ...
                            <div class="text-center">
                                <!--begin::Symbol-->
                                <i class="ki-duotone ki-chart-pie-4 fs-2tx text-success"><span
                                ...
                                <div class="mt-1">
                                    <!--begin::Animation-->
                                    <div class="fs-lg-2hx fs-2x fw-bold text-gray-800 d-flex align-items-center">
                                        <div class="min-w-50px" data-kt-countup="true" data-kt-countup-value="80">0
                                        </div>
                        ...
                        <div class="octagon d-flex flex-center h-200px w-200px bg-body mx-lg-10">
                            ...
                            <div class="text-center">
                                <!--begin::Symbol-->
                                <i class="ki-duotone ki-basket fs-2tx text-info"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                                <!--end::Symbol-->
                                ...
                                <div class="mt-1">
                                    <!--begin::Animation-->
                                    <div class="fs-lg-2hx fs-2x fw-bold text-gray-800 d-flex align-items-center">
                                        <div class="min-w-50px" data-kt-countup="true" data-kt-countup-value="35">0
                                        </div>
                ...
                <div class="fs-2 fw-semibold text-muted text-center">
                    <a href="/axel-html-pro/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy</a>
            ...
            <div class="row g-10">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-xl-stretch me-md-6">
                        ...
                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                            href="<?= PUBLIC_URL ?>media/stock/600x400/img-73.jpg">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="background-image:url('<?= PUBLIC_URL ?>media/stock/600x400/img-73.jpg')">
                            </div>
                            <!--end::Image-->
                        ...
                        <div class="m-0">
                            <!--begin::Title-->
                            <a href="/axel-html-pro/pages/user-profile/overview.html"
                            ...
                            <div class="fs-6 fw-bold">
                                <!--begin::Author-->
                                <a href="/axel-html-pro/apps/projects/users.html"
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-xl-stretch mx-md-3">
                        <!--begin::Overlay-->
                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                            href="<?= PUBLIC_URL ?>media/stock/600x400/img-74.jpg">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="background-image:url('<?= PUBLIC_URL ?>media/stock/600x400/img-74.jpg')">
                            </div>
                            <!--end::Image-->
                ...
                <div class="col-md-4">
                    ...
                    <div class="card-xl-stretch ms-md-6">
                        <!--begin::Overlay-->
                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                            href="<?= PUBLIC_URL ?>media/stock/600x400/img-47.jpg">
                            <!--begin::Image-->
                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                style="background-image:url('<?= PUBLIC_URL ?>media/stock/600x400/img-47.jpg')">
                            </div>
                            <!--end::Image-->
                ...
                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                    ...
                    <div class="text-center">
                        ...
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-1.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-2.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-5.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-20.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-23.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-12.jpg')">
                        </div>
                        <!--end::Photo-->
                    ...
                    <div class="text-center">
                        <!--begin::Photo-->
                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                            style="background-image:url('<?= PUBLIC_URL ?>media/avatars/300-9.jpg')">
                        </div>
                        <!--end::Photo-->
        ...
        <div class="card mb-4 bg-light text-center ">
            ...
            <div class="card-body py-12">
                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/facebook-4.svg" class="h-30px my-2" alt="" />
                </a>
                <!--end::Icon-->

                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/instagram-2-1.svg" class="h-30px my-2"
                        alt="" />
                </a>
                <!--end::Icon-->
                ...
                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/github.svg" class="h-30px my-2" alt="" />
                </a>
                <!--end::Icon-->

                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/behance.svg" class="h-30px my-2" alt="" />
                </a>
                <!--end::Icon-->

                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/pinterest-p.svg" class="h-30px my-2" alt="" />
                </a>
                <!--end::Icon-->

                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/twitter.svg" class="h-30px my-2" alt="" />
                </a>
                <!--end::Icon-->

                <!--begin::Icon-->
                <a href="#" class="mx-4">
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/dribbble-icon-1.svg" class="h-30px my-2"
                        alt="" />
                </a>
                <!--end::Icon-->
            </div>
