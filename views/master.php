...
<!-- Mirrored from preview.keenthemes.com/axel-html-pro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 13:43:17 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="<?= PUBLIC_URL ?>plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?= PUBLIC_URL ?>plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
            ...
            <!--begin::Header-->
            <?php include 'views/public/inc/header.php' ?>
            <!--end::Header-->
            <!--begin::Wrapper-->
                        ...
                        <div class="d-flex flex-column flex-row-fluid">
                            ...
                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
                                ...
                                <div class="page-title d-flex align-items-center me-3">
                                    <img alt="Logo" src="<?= PUBLIC_URL ?>media/svg/misc/earth.svg" class="h-60px me-5" />
                                ...
                                <!--begin::Items-->
                                <div class="items d-flex gap-4 gap-lg-13">
                                    <!--begin::Item-->
                                    <div class="d-flex flex-column">
                                        <!--begin::Number-->
                                        <span class="item-number fs-3 mb-1">$23,467.92</span>
                                        <!--end::Number-->
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Number-->
                                        <span class="item-number fs-3 mb-1">$1,748.03</span>
                                        <!--end::Number-->
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Number-->
                                        <span class="item-number fs-3 mb-1">3.8%</span>
                                        <!--end::Number-->
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Number-->
                                        <span class="item-number fs-3 mb-1">-7.4%</span>
                                        <!--end::Number-->
                    ...
                    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_content" class="app-content ">
                                ...
                                <!--begin::Content menu-->
                                <?php include 'views/public/inc/menu.php' ?>    
                                <!--begin::Content menu-->
                                <!--begin::Row-->
                                ...
                                <?php 
                                    if (isset($pages) && file_exists($pages)) {
                                        ...
                                        // header('location: ' . project . 'errors/404');
    ...
    <div id="kt_app_layout_builder" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="app-settings"
        ...
        <div class="card border-0 shadow-none rounded-0 w-100">
            ...
            <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
                ...
                style="background-image:url('public/media/misc/layout/customizer-header-bg.jpg')">
            ...
            <div class="card-body position-relative" id="kt_app_layout_builder_body">
                ...
                <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <form class="form" method="POST" id="kt_app_layout_builder_form"
                        action="https://preview.keenthemes.com/axel-html-pro/index.php">
                                ...
                                <div class="row " data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?= PUBLIC_URL ?>media/preview/light.png" class="mw-100 mh-250px"
                                                    alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="<?= PUBLIC_URL ?>media/preview/dark.png" class="mw-100 mh-250px"
                                                    alt="" />
                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?= PUBLIC_URL ?>media/avatars/300-14.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="<?= PUBLIC_URL ?>media/avatars/300-2.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="<?= PUBLIC_URL ?>media/avatars/300-20.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?= PUBLIC_URL ?>media/avatars/300-1.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?= PUBLIC_URL ?>media/avatars/300-23.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="<?= PUBLIC_URL ?>media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="/axel-html-pro/apps/projects/project.html" class="w-30px me-3"
                                                src="<?= PUBLIC_URL ?>media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="/axel-html-pro/apps/projects/project.html" class="w-30px me-3"
                                                src="<?= PUBLIC_URL ?>media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?= PUBLIC_URL ?>media/stock/600x400/img-29.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?= PUBLIC_URL ?>media/stock/600x400/img-31.jpg" />
                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="<?= PUBLIC_URL ?>media/stock/600x400/img-40.jpg" />
                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="<?= PUBLIC_URL ?>media/avatars/300-4.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?= PUBLIC_URL ?>media/avatars/300-25.jpg" /></div><!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="<?= PUBLIC_URL ?>media/avatars/300-1.jpg" /></div><!--end::Avatar-->
                            </div>
                            <!--end::User-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-1.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-3.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-8.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-26.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-21.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-34.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="<?= PUBLIC_URL ?>media/stock/600x400/img-27.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
                        ...
                        <div class="d-flex flex-column flex-center mb-3">
                            ...
                            <div class="mb-2">
                                <img src="<?= PUBLIC_URL ?>media/svg/payment-methods/paypal.svg" alt=""
                                    class="h-30px me-3 rounded-1" />

                                <img src="<?= PUBLIC_URL ?>media/svg/payment-methods/visa.svg" alt=""
                                    class="h-30px me-3 rounded-1" />

                                <img src="<?= PUBLIC_URL ?>media/svg/payment-methods/mastercard.svg" alt=""
                                    class="h-30px me-3 rounded-1" />

                                <img src="<?= PUBLIC_URL ?>media/svg/payment-methods/americanexpress.svg" alt=""
                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-6.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-1.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-5.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-25.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-9.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-23.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-12.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-13.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="<?= PUBLIC_URL ?>media/avatars/300-21.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="<?= PUBLIC_URL ?>media/illustrations/dozzy-1/1.png" alt=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="<?= PUBLIC_URL ?>media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />
    ...
    <!--begin::Javascript-->
    <script>
        var hostUrl = "<?= PUBLIC_URL ?>index.html";        </script>
    ...
    <script src="<?= PUBLIC_URL ?>plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
    ...
    <script src="<?= PUBLIC_URL ?>plugins/custom/datatables/datatables.bundle.js"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="<?= PUBLIC_URL ?>js/widgets.bundle.js"></script>
    <script src="<?= PUBLIC_URL ?>js/custom/widgets.js"></script>
    <script src="<?= PUBLIC_URL ?>js/custom/apps/chat/chat.js"></script>
    <script src="<?= PUBLIC_URL ?>js/custom/utilities/modals/upgrade-plan.js"></script>
    <script src="<?= PUBLIC_URL ?>js/custom/utilities/modals/users-search.js"></script>
...
<!-- Mirrored from preview.keenthemes.com/axel-html-pro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 13:44:56 GMT -->
