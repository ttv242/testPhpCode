        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Flag-->
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/dribbble-icon-1.svg" class="me-4 w-30px"
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Flag-->
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/linkedin-1.svg" class="me-4 w-30px"
                        style="border-radius: 4px" alt="" />
                    <!--end::Flag-->
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Flag-->
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/slack-icon.svg" class="me-4 w-30px"
                        style="border-radius: 4px" alt="" />
                    <!--end::Flag-->
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Flag-->
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/youtube-3.svg" class="me-4 w-30px" style="border-radius: 4px"
                        alt="" />
                    <!--end::Flag-->
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Flag-->
                    <img src="<?= PUBLIC_URL ?>media/svg/brand-logos/instagram-2-1.svg" class="me-4 w-30px"
                        style="border-radius: 4px" alt="" />
                    <!--end::Flag-->
        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-5">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Top Referral
                        Sources</span>

                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Counted in
                        Millions</span>
                </h3>
                <!--end::Title-->
                        ...
                        <thead>
                            <tr class="fs-7 fw-bold border-0 text-gray-400">
                                ...
                                <th class="min-w-150px text-end pe-0" colspan="2">
                                    SESSIONS</th>
                                <th class="text-end min-w-150px" colspan="2">CONVERSION
                                    RATE</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
                            ...
                            <tr>
                                ...
                                <td class="" colspan="2">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <span
                                            class="text-danger min-w-60px d-block text-end fw-bold fs-6">-57.02%</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="" colspan="2">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <span
                                            class="text-success min-w-60px d-block text-end fw-bold fs-6">+28.73%</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="" colspan="2">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <span
                                            class="text-danger min-w-60px d-block text-end fw-bold fs-6">-12.29%</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="" colspan="2">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <span
                                            class="text-success min-w-60px d-block text-end fw-bold fs-6">+3.06%</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
    ...
    <div class="col-xl-6 mb-5 mb-xl-10">
        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-5">
                <!--begin::Title-->
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Top Performing
                        Pages</span>
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fs-7 fw-bold border-0 text-gray-400">
                                ...
                                <th class="min-w-100px text-end pe-0" colspan="2">CLICKS
                                </th>
                                <th class="text-end min-w-100px" colspan="2">AVG.
                                    POSITION</th>
                            </tr>
                        </thead>
                        <!--end::Table head-->
    ...
    <div class="col-xl-6 mb-5 mb-xl-10">
        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-5">
                <!--begin::Title-->
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Top Queries by
                        Clicks</span>

                    <span class="text-gray-400 pt-2 fw-semibold fs-6">Counted in
                        Millions</span>
                </h3>
                <!--end::Title-->
                ...
                <div class="table-responsive mb-n2">
                    ...
                    <table class="table table-row-dashed gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="#" class="text-gray-600 fw-bold text-hover-primary mb-1 fs-6">Buy
                                        phone online</a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="text-gray-600 fw-bold text-hover-primary mb-1 fs-6">Top
                                        10 Earbuds</a>
                                </td>
                                <td class="d-flex align-items-center border-0">
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="text-gray-600 fw-bold text-hover-primary mb-1 fs-6">OLED
                                        TV in Amsterdam</a>
                                </td>
                                <td class="d-flex align-items-center border-0">
                                    <span class="fw-bold text-gray-800 fs-6 me-3">263</span>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="text-gray-600 fw-bold text-hover-primary mb-1 fs-6">Macbook
                                        M1</a>
                                </td>
                                <td class="d-flex align-items-center border-0">
                                    <span class="fw-bold text-gray-800 fs-6 me-3">263</span>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="text-gray-600 fw-bold text-hover-primary mb-1 fs-6">Best
                                        noise cancelation headsets</a>
                                </td>
                                <td class="d-flex align-items-center border-0">
                                    <span class="fw-bold text-gray-800 fs-6 me-3">263</span>
        ...
        <div class="card card-flush overflow-hidden h-xl-100">
            ...
            <div class="card-header py-5">
                ...
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Reports by states
                        and ganders</span>
                </h3>
                <!--end::Title-->
            ...
            <div class="card-body d-flex align-items-end">
                ...
                <div class="w-100">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-30px me-5">
                            <span class="symbol-label">
                                <i class="ki-duotone ki-abstract-39 fs-3 text-gray-600"><span class="path1"></span><span
                                        class="path2"></span></i>
                            </span>
                        </div>
                        <!--end::Symbol-->
    ...
    <div class="col-xl-4 mb-5 mb-xl-0">
        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7 mb-7">
                <!--begin::Title-->
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Stats by
                        Department</span>
                    <span class="text-gray-400 mt-1 fw-semibold fs-6">8k social
                        visitors</span>
                </h3>
